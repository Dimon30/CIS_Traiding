...
> lift 1.246, hit rate 85.8% и частоту 0.40 сигнала в неделю. Актуальное сравнение:
> `results/experiments/20260904_h008_pooling_v2_rf_logistic/RESULTS.md`.

Исторический результат указанного benchmark bundle: **random_forest / pooled_with_corridor_thresholds**, средний lift по коридорам **1.42**, hit rate **85.4%**, частота **0.43 сигнала в неделю**. Эти значения сохранены только для воспроизводимости старого запуска и не являются текущими метриками модели.
