...
Основной runner — `scripts/run_experiment.py`. Каноническим выбранным запуском
является `20260905_wave0_temporal_v3_baseline`; его краткий итог находится в
`results/experiments/20260905_wave0_temporal_v3_baseline/RESULTS.md`. Имя другого
каталога само по себе не означает, что результат принят как текущая модель.
