...
try {
  ...
  assert((await page.locator('[data-signal-day="true"]').allInnerTexts()).join(",") === "3,17,31", "Октябрьские сигналы должны быть равномерно разнесены")
  ...
  assert((await page.locator('[data-signal-day="true"]').allInnerTexts()).join(",") === "5,26", "Сентябрьские сигналы должны быть равномерно разнесены")
  ...
  assert((await page.locator('[data-signal-day="true"]').allInnerTexts()).join(",") === "15,29", "Ноябрьские сигналы должны быть равномерно разнесены")
